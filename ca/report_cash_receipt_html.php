<?php
	...
	$dtl_arr = $pd->getPickDtlsRange($start_date, $end_date, $start_item, $end_item, "d");
	$dtl_num = count($dtl_arr);
?>
<HTML>
<HEAD>
<TITLE>Sales by Item Report - Detail</TITLE>
...
<BODY>
   <table width="100%" border="0" cellspacing="1" cellpadding="0">
	  <tr> 
		<td align="center"><strong><FONT SIZE="5" COLOR="red">Sales by Item Report(Detail)</strong></FONT></td>
	  </tr>
	  <tr>
		<td align="center">
		  <font size="3">
...
?>
              ...
              <th bgcolor="gray" align="center" width="15%"><font color="white">Item Desc</font></th>
