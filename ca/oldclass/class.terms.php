...
class Terms extends AR {
	...
	function getTerms($code="") {
		...
		if ($ar_type == 't') $this->query .= "AND (term_type = 'r' OR term_type = 'b') ";
		else if ($ar_type == 'f') $this->query .= "AND (term_type = 'p' OR term_type = 'b') ";
		$this->query .= "LIMIT 1 ";
	...
	function getLastTerms($filter="") {
		...
		if ($ar_type == 't') $this->query .= "WHERE (term_type = 'r' OR term_type = 'b') ";
		else if ($ar_type == 'f') $this->query .= "WHERE (term_type = 'p' OR term_type = 'b') ";
