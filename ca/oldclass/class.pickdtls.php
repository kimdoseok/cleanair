...
//echo $this->query."<br>";
	...
	function getPickDtlsSlsSum($code) {
		$this->query = "SELECT sum(pickdtl_qty) AS sum_qty FROM pickdtls WHERE pickdtl_slsdtl_id = '$code' ";
//echo $this->query."<br>";
...
//echo $this->query."<br>";
	...
	function getPickDtlsRangeCust($dfr="", $dto="", $cfr="", $cto="", $ty="s") { // s for summary, d for detail
		if ($page < 1) $page = 0;
		else $page--;
		$where = "WHERE d.pickdtl_pick_id=p.pick_id ";
		$where .= " AND d.pickdtl_slsdtl_id=s.slsdtl_id ";
