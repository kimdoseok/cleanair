...
<FORM METHOD="POST" ACTION="ic_proc.php?cmd=cate_price&cate_id=<?= $cate_code ?>">
<tr align="center"> 
  <td colspan="2" height="35"><strong>Price Adjustment of "<?= $cate_code ?>"</strong></td>
</tr>
<tr> 
...
<tr> 
  ...
  <td width="60%" align="left"> 
    <INPUT TYPE="radio" NAME="adj_type" VALUE="p" checked>Percent
    <INPUT TYPE="radio" NAME="adj_type" VALUE="a">Amount
  </td>
</tr>
<tr align="center"> 
