...
//-->
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
					  ...
					  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                         <tr> 
						  <td width="30%" align="left"><FONT SIZE="2"><A HREF="javascript:AddDtl()">Add Detail</A></FONT></td>
                      ...
                      <td colspan="1"> 
					    <table width="100%" border="0" cellspacing="1" cellpadding="0">
							<tr> 
							  ...
							  <th bgcolor="gray" width="10%"><font color="white">Unit</font></th>
...
?>
        <td align="center"> <a href="itm_build_details.php?ty=e&ht=e&did=<?= $i ?>"> 
          <?= $i+1 ?>
          </a> </td>
        <td> 
