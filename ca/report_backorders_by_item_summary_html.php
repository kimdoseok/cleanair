<?php
	...
	$dtl_arr = $sl->getPenDtlsRange($start_date, $end_date, $start_item, $end_item, "s");
...
<HTML>
<HEAD>
<TITLE>Back Orders by Item Report - Summary</TITLE>
...
<BODY>
   <table width="100%" border="0" cellspacing="1" cellpadding="0">
	  <tr> 
		<td align="center"><strong><FONT SIZE="5" COLOR="red">Back Orders by Item Report(Summary)</strong></FONT></td>
	  </tr>
	  <tr>
		<td align="center">
		  <font size="3">
...
?>
     <tr>
       <td align="right" colspan="5" bgcolor="silver"><b>Total:</b></td>
       <td align="right" colspan="1" bgcolor="silver"><?= number_format($amt_total, 2, ".", ",") ?></td>
     </tr>
<?php
	}
?>
