...
?>
                    ...
                    <tr align="right"> 
                      <td colspan="8"><strong><?= $label[$lang][List_Disburseements] ?></strong></td>
                    </tr>
                    <tr>
...
<?php
	...
	$recs = $c->getDisburseList($condition, $filtertext, $reverse, $page, $limit);
	$n = new Navigates();
...
?>
                            ...
                            <td width="5%" align="center"> 
                              <a href="ap_proc.php?cmd=disbur_del&disbur_id=<?= $recs[$i][disbur_id] ?>"><?= $label[$lang]["Del"] ?></a>
                            </td>
                          </tr>
<?php
	}
