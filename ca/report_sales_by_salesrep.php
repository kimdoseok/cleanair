...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr align="right"> 
    <td><strong>Sales By Sales Rep. Report</strong></td>
  </tr>
  <tr>
    <td align="left"><font size="2">&nbsp; </font> 
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
	    <FORM METHOD=POST ACTION="report_sales_by_salesrep_out.php">
		...
		<tr>
		  ...
		  <td width="50%"><?= $f->fillTextBox("start_rep", $start_rep, 20, 32, "inbox") ?>
			<A HREF="javascript:openSalesRepBrowse('start_rep')">Lookup</a></td>
		  <td width="10%">&nbsp;</td>
		</tr>
		<tr>
		  <td width="10%">&nbsp;</td>
		  ...
		  <A HREF="javascript:openSalesRepBrowse('end_rep')">Lookup</a></td>
		  <td width="10%">&nbsp;</td>
		</tr>
        <tr>
          <td colspan="4">&nbsp;</td>
