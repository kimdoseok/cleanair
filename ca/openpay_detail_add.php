<?php
	...
	$ac = new Accts();
	$rcptdtl_acct_code = $default["astr_acct"];

	$ac_arr = $ac->getAccts($rcptdtl_acct_code);
	$rcptdtl_desc = $ac_arr["acct_desc"];
...
<!--
	function AddDtl() {
		...
		f.action = "openpayments_proc.php";
		f.cmd.value = "openpay_detail_add";
		f.method = "post";
		f.submit();
	}
...
//-->
						...
						<form method=get action="ar_proc.php">
							...
							<?= $f->fillHidden("rcptdtl_id", $rcptdtl_id) ?>
                    <tr align="right"> 
                      <td colspan="8"><strong>New Opempayment Detail</strong></td>
                    </tr>
                    <tr align="right"> 
                      <td colspan="8" align="left"><font size="2">
							   | <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?ty=a&ht=e&rcpt_id=$rcpt_id&rdptdtl_id=$rcptdtl_id" ?>">New</a> |
                        <a href="<?php echo "openpayments.php?ty=e&rcpt_id=$rcpt_id" ?>">Header</a> |</font></td>
                    </tr>
                    <tr align="right"> 
            ...
            <td width="477" align="right"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr> 
                  ...
                  <td width="308"> 
					...
					<A HREF="javascript:openPickBrowse('rcptdtl_pick_id')"><font size="2">Look up</font></A>
                  </td>
                </tr>
                <tr> 
					...
					<tr>
					  <td colspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<td width="37%"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                          <tr> 
                            <td width="97" bgcolor="silver">Check_no:</td>
                            <td width="308"> 
                              <?= $rcpt_check_no ?>
                            </td>
                          </tr>
...
?>
                          ...
                          <tr> 
                            <td width="97" bgcolor="silver">Amount:</td>
                            <td> 
                          ...
                          <tr> 
                            <td width="97" bgcolor="silver">User_no&nbsp;</td>
                            <td> 
                              <?= $rcpt_user_code ?>
                            </td>
                          </tr>
