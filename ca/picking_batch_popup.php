<?php
	...
	$selbox = array(0=>array("value"=>"code", "name"=>"Picking Number"),
					1=>array("value"=>"date", "name"=>"Picking Date")
	);
...
<HTML>
<HEAD>
<title>Picking Ticket Batch Process</title>
...
?>
  ...
  <BODY leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="white">
    <table width="100%" border="0" cellspacing="1" cellpadding="0">
      <tr align="center"> 
        <td colspan="4"><strong>Picking Ticket Batch</strong></td>
      </tr>
	  <form method="post" action="ar_proc.php">
	  <tr> 
        <td width="10%" align="center">&nbsp;</td>
        <td width="30%" align="right" bgcolor="silver">From</td>
        <td width="50%"><?= $f->fillTextBox("from",$from,16) ?></td>
        <td width="10%">&nbsp;</td>
      </tr>
	  <tr>
        <td>&nbsp;</td>
	  ...
	  <tr> 
        ...
        <td>
		  ...
		  <INPUT TYPE="radio" NAME="worktype" VALUE="invoice">Invoice
		</td>
        <td>&nbsp;</td>
      </tr>
      <tr> 
