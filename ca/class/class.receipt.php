...
//echo $this->query."<br>";
	...
	function getReceiptList($condition="", $filtertext="", $reverse="f", $page=1, $limit=20) {
		...
		if ($reverse != "t") {
			if ($condition == "code") $this->query .= "ORDER BY rcpt_id DESC ";
			else if ($condition == "cust") $this->query .= "ORDER BY rcpt_cust_code,rcpt_id DESC ";
			else if ($condition == "date") $this->query .= "ORDER BY rcpt_id DESC ";
			else if ($condition == "desc") $this->query .= "ORDER BY rcpt_id DESC ";
			else if ($condition == "check") $this->query .= "ORDER BY rcpt_id DESC ";
			else if ($condition == "amt") $this->query .= "ORDER BY rcpt_id DESC ";
			else if ($condition == "type") $this->query .= "ORDER BY rcpt_id DESC ";
			else $this->query .= "ORDER BY rcpt_id DESC ";
		} else {
			if ($condition == "code") $this->query .= "ORDER BY rcpt_id ";
			else if ($condition == "cust") $this->query .= "ORDER BY rcpt_cust_code DESC,rcpt_id DESC ";
			else if ($condition == "date") $this->query .= "ORDER BY rcpt_id ";
			else if ($condition == "desc") $this->query .= "ORDER BY rcpt_id ";
			else if ($condition == "check") $this->query .= "ORDER BY rcpt_id ";
			else if ($condition == "amt") $this->query .= "ORDER BY rcpt_id ";
			else if ($condition == "type") $this->query .= "ORDER BY rcpt_id ";
			else $this->query .= "ORDER BY rcpt_id ";
		}
