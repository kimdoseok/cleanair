...
<BODY leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="white">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr align="right"> 
                      <td colspan="8"><strong>Materials Popup</strong></td>
                    </tr>
                    <tr align="right"> 
...
?>
							...
							<a href="javascript:setCode('<?= rawurlencode($recs[$i]["material_code"]) ?>');"><?= $recs[$i]["material_code"] ?></a>
                            </td>
                            <td width="80%"> 
