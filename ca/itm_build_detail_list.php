		...
		function updateForm() {
			...
			document.form1.submit();
                  ...
                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr align="right"> 
                      <td colspan="1"><strong><?= $label[$lang]["List_Account"] ?></strong></td>
                    </tr>
                    <tr>
    <td colspan="1" align="left"><font size="2">&nbsp; </font> 
...
<?php
	$limit = 20;
	$c = new Items();
	$numrows = $c->getItemsRows($sc);
	$recs = $c->getItemsList($sc, $filtertext, $reverse, $page, $limit);
