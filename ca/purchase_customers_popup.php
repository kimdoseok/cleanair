...
function setCode(value, name, addr1, addr2, addr3, city, state, zip, taxrate, bal, wday, tel, rep) {
	var f = document.forms[0];

	var s = self.opener.document.forms[0];
	if (f.ty.value=="s") {
		self.opener.document.forms[0].purch_ship_name.value = name;
		self.opener.document.forms[0].purch_ship_addr1.value = addr1;
		self.opener.document.forms[0].purch_ship_addr2.value = addr2;
	
		self.opener.document.forms[0].purch_ship_addr3.value = addr3;
	
		self.opener.document.forms[0].purch_ship_city.value = city;
	
		self.opener.document.forms[0].purch_ship_state.value = state;
	
		self.opener.document.forms[0].purch_ship_zip.value = zip;
		self.opener.document.forms[0].purch_ship_tel.value = tel;
	} else {
		self.opener.document.forms[0].purch_cust_name.value = name;
		self.opener.document.forms[0].purch_cust_addr1.value = addr1;
		self.opener.document.forms[0].purch_cust_addr2.value = addr2;
		self.opener.document.forms[0].purch_cust_addr3.value = addr3;
		self.opener.document.forms[0].purch_cust_city.value = city;
		self.opener.document.forms[0].purch_cust_state.value = state;
		self.opener.document.forms[0].purch_cust_zip.value = zip;
		self.opener.document.forms[0].purch_cust_tel.value = tel;
	}
...
?>
                    ...
                    <tr align="right"> 
                      <td colspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="64%" align="center"><a href="<?= htmlentities($_SERVER['PHP_SELF'])."?objname=$objname&pg=1&cn=$cn&ft=$ft&th=$ty" ?>">&lt;&lt;<?= $label[$lang]["First"] ?></a>
                              &nbsp; <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?objname=$objname&pg=$prevpage&cn=$cn&ft=$ft&th=$ty" ?>">&lt;<?= $label[$lang]["Prev_1"] ?></a> &nbsp; 
										<font color="gray"><?= "[$page / $totalpage]" ?></font>
                              &nbsp; <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?objname=$objname&pg=$nextpage&cn=$cn&ft=$ft&th=$ty" ?>"><?= $label[$lang]["Next_1"] ?>&gt;</a>
                              &nbsp; <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?objname=$objname&pg=$totalpage&cn=$cn&ft=$ft&th=$ty" ?>"><?= $label[$lang]["Last"] ?>&gt;&gt;</a></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table>
