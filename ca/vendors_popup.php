...
<BODY leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" bgcolor="white">
                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    <tr align="right"> 
                      <td colspan="8"><strong>Vendor Popup</strong></td>
                    </tr>
                    <tr align="right"> 
                      <td colspan="8"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                          <tr> 
                            <th bgcolor="gray"><font color="white">Vend #</font></th>
...
<?php
	...
	$recs = $c->getVendsList($condition, $filtertext, $reverse, $page, $limit);
	$n = new Navigates();
...
?>
							...
							<a href="javascript:setCode('<?= rawurlencode($recs[$i]["vend_code"]) ?>');"><?= $recs[$i]["vend_code"] ?></a>
