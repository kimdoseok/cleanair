                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
						...
						<INPUT TYPE="hidden" name="cmd" value="vend_edit">
                    <tr align="right"> 
                      <td colspan="8"><strong><?= $label[$lang][Edit_Vendor] ?></strong></td>
                    </tr>
                    <tr> 
                      <td colspan="8" align="left"><font size="2"> | <a href="<?php echo htmlentities($_SERVER['PHP_SELF'])."?ty=a" ?>"><?= $label[$lang]["New_1"] ?></a>  |
								<a href="<?php echo htmlentities($_SERVER['PHP_SELF'])."?ty=v&vend_code=$vend_code" ?>"><?= $label[$lang]["View"] ?></a>  |
                        <a href="<?php echo htmlentities($_SERVER['PHP_SELF'])."?ty=l" ?>"><?= $label[$lang]["List_1"] ?></a>  | </font></td>
                    </tr>
                    <tr align="right"> 
                      <td colspan="8"> <table width="100%" border="0" cellspacing="1" cellpadding="0">
          <tr bgcolor="white"> 
            <td width="466" valign="top" align="right"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr> 
            ...
            <td width="12">&nbsp; </td>
            <td width="270" valign="top" align="right"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                <tr> 
