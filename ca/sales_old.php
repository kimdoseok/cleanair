...
?>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr align="right"> 
                      <td colspan="8"><strong>New Sales</strong></td>
                    </tr>
                    <tr align="right"> 
                      ...
                      <td colspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="62%"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                ...
                                <tr> 
                                  <td height="20" align="right" bgcolor="silver">Ship To:</td>
                                  <td> 
                                    <?= $f->fillTextBox("abc", $abc, 32, 32, "inbox") ?>
                                  </td>
                                </tr>
                            ...
                            <td width="36%"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                <tr> 
                                  <td width="41%" align="right" bgcolor="silver">&nbsp;</td>
                                  <td width="59%">&nbsp;</td>
                                </tr>
                                <tr> 
                    ...
                    <tr align="right"> 
                      <td colspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr valign="top">
                            <td width="62%"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                <tr> 
                                  <td width="24%" align="right" bgcolor="silver">Ship Via</td>
                                  <td width="76%"> 
                                    <?= $f->fillTextBox("abc", $abc, 20, 32, "inbox") ?>
                                  </td>
                                </tr>
                            ...
                            <td width="36%"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                                <tr> 
                                  <td width="41%" align="right" bgcolor="silver">Freight&nbsp;</td>
                                  <td width="59%"> 
                                    <?= $f->fillTextBox("style_code$i", sprintf("%0.2f", $style_code.$i), 10, 16, "inbox") ?>
                                  </td>
                                </tr>
                                ...
                                <tr> 
                                  <td align="right" bgcolor="silver">Total Amount&nbsp;</td>
                                  <td> 
                                    <?= $f->fillTextBox("style_code$i", sprintf("%0.2f", $style_code.$i), 10, 16, "inbox") ?>
                                  </td>
                                </tr>
                    ...
                    <tr align="right"> 
                      <td colspan="8"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            ...
                            <td width="94"> 
                              <?= $f->fillTextBoxNum("style_code$i", sprintf("%0.2f", $style_code.$i), 10, 16, "inbox") ?>
                            </td>
                          </tr>
                          <tr> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td width="97" height="20">Ship To:</td>
    <td> 
      <?= $f->fillTextBox("abc", $abc, 32, 32, "inbox") ?>
    </td>
    <td width="11">&nbsp;</td>
...
<p>&nbsp;</p><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="64%" align="center"><input type="button" name="Button522" value="&lt;&lt;"> 
      &nbsp; <input type="button" name="Button2222" value="&lt;"> &nbsp; <input type="button" name="Button3222" value="&gt;"> 
