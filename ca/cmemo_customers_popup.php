...
function setCode(value, name, addr1, addr2, addr3, city, state, zip, taxrate) {
	var f = document.forms[0];

	var s = self.opener.document.forms[0];
	self.opener.document.forms[0].<?= $objname ?>.value = value;
	self.opener.document.forms[0].cmemo_name.value = name;
	self.opener.document.forms[0].cmemo_addr1.value = addr1;
	self.opener.document.forms[0].cmemo_addr2.value = addr2;
	self.opener.document.forms[0].cmemo_addr3.value = addr3;
	self.opener.document.forms[0].cmemo_city.value = city;
	self.opener.document.forms[0].cmemo_state.value = state;
	self.opener.document.forms[0].cmemo_zip.value = zip;
	self.opener.document.forms[0].cmemo_taxrate.value = taxrate;
