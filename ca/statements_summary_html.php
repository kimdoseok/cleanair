...
?>
        <tr bgcolor="white"> 
          ...
          <td><font size="2" face="Arial, Helvetica, sans-serif">Invoice: <?= $pick_arr[$j]["pick_id"] ?>
<?php
...
?>
        <tr bgcolor="white"> 
          ...
          <td align="right"><font size="2" face="Arial, Helvetica, sans-serif"><?= number_format($cmemo_arr[$j]["cmemo_total"]*-1,2,".",",") ?></font></td>
        </tr>
<?php
	}
