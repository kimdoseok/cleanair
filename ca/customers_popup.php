                  ...
                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr align="right"> 
                      <td colspan="8"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                          <tr> 
                            <th bgcolor="gray"><font color="white">Cust #</font></th>
...
<?php
	...
	for ($i=0; $i<$numrecs; $i++) {
		...
		$rcpt_amt = $ca_arr["rcpt_amt"] ?? 0;
		$rcpt_disc_amt = $ca_arr["rcpt_disc_amt"] ?? 0;
		$ramt = number_format($rcpt_amt,2,".",",")."(".$rcpt_disc_amt.")";
?>
                            <td width="10%" align="center"> 
							<a href="javascript:setCode('<?= addslashes($recs[$i]["cust_code"]) ?>');"><?= $recs[$i]["cust_code"] ?></a></td>
