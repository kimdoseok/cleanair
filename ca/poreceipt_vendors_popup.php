...
function setCode(value, name, addr1, addr2, addr3, city, state, zip, taxrate, bal, wday, tel) {
	...
	self.opener.document.forms[0].porcpt_vend_name.value = name;
	self.opener.document.forms[0].porcpt_vend_addr1.value = addr1;
	self.opener.document.forms[0].porcpt_vend_addr2.value = addr2;
	
	self.opener.document.forms[0].porcpt_vend_addr3.value = addr3;
	
	self.opener.document.forms[0].porcpt_vend_city.value = city;
	
	self.opener.document.forms[0].porcpt_vend_state.value = state;
	
	self.opener.document.forms[0].porcpt_vend_zip.value = zip;
	self.opener.document.forms[0].porcpt_vend_tel.value = tel;
