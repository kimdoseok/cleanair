...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr align="right"> 
    <td><strong>Sales By Item Report</strong></td>
  </tr>
  <tr>
    <td align="left"><font size="2">&nbsp; </font> 
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
	    <FORM METHOD=POST ACTION="report_sales_by_item_out.php">
        ...
        <tr>
          ...
          <td width="1%">&nbsp;</td>
          <td width="50%"><?= $f->fillTextBox("start_vend", $start_vend, 20, 32, "inbox") ?>
			<A HREF="javascript:openVendBrowse('start_vend')">Lookup</a></td>
          <td width="10%">&nbsp;</td>
        </tr>
        <tr>
          <td width="10%">&nbsp;</td>
          ...
          <td width="1%">&nbsp;</td>
          <td width="50%"><?= $f->fillTextBox("end_vend", $end_vend, 20, 32, "inbox") ?>
			  <A HREF="javascript:openVendBrowse('end_vend')">Lookup</a></td>
          <td width="10%">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="4">&nbsp;</td>
        ...
        <tr>
          ...
          <td width="50%">
		    <SELECT NAME="show_format">
			  ...
			  <OPTION VALUE="rr">RR Street Format</OPTION>
		    </SELECT>
		  </td>
          <td width="10%">&nbsp;</td>
        </tr>
