...
//-->
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr align="right"> 
                      <td colspan="8"><strong>View Sales</strong></td>
                    </tr>
                    <tr align="left"> 
...
?>
							<a href="<?php echo htmlentities($_SERVER['PHP_SELF'])."?ty=e&sale_id=$sale_id" ?>"><?= $label[$lang]["Edit"] ?></a> |
<?php
	}
?>
                      ...
                      <td colspan="4" align="right"><font size="2">
							 | <a href="<?php echo "ar_proc.php?cmd=sale_print&ty=v&sale_id=$sale_id" ?>">Print</a> | </font>
                      </td>
                    </tr>
                    <tr align="right"> 
...
<?php
	...
	$d = new SaleDtls();
	$pd = new PickDtls();
	$recs = $d->getSaleDtlsList($sale_id);
	$y = new Items();
	$subtotal = 0;
...
?>
        ...
        <td width="36%"><table width="100%" border="0" cellspacing="1" cellpadding="0">
            ...
            <tr>
              ...
              <td align="right">
				 <?= number_format($sale_deposit_amt,2,".", ",") ?>
              </td>
            </tr>
            <tr align="right">
              <td bgcolor="silver" valign="top" align="right"><?= $label[$lang]["Total_Amount"] ?></td>
              <td>
                <?= sprintf("%0.2f", $sale_tax_amt+$sale_freight_amt+$subtotal-$sale_deposit_amt) ?>
              </td>
            </tr>
          </table></td>
      </tr>
                    ...
                    <tr align="right"> 
                      <td colspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td width="64%" align="center"><a href="<?= htmlentities($_SERVER['PHP_SELF'])."?ty=v&dir=-2&sale_id=$sale_id" ?>">&lt;&lt;<?= $label[$lang]["First"] ?></a>
                              &nbsp; <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?ty=v&dir=-1&sale_id=$sale_id" ?>">&lt;<?= $label[$lang]["Prev_1"] ?></a> &nbsp; 
                              &nbsp; <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?ty=v&dir=1&sale_id=$sale_id" ?>"><?= $label[$lang]["Next_1"] ?>&gt;</a>
                              &nbsp; <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?ty=v&dir=2&sale_id=$sale_id" ?>"><?= $label[$lang]["Last"] ?>&gt;&gt;</a></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table>
