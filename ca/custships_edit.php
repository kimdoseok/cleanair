				  <table width="100%" border="0" cellspacing="1" cellpadding="0">
						...
						<INPUT TYPE="hidden" name="cmd" value="custship_edit">
						<?= $f->fillHidden("custship_id",$custship_id) ?>
                    <tr align="right"> 
                      <td colspan="8"><strong>Edit Shipping Address</strong></td>
                    </tr>
                    <tr> 
                      <td colspan="4" align="left"><font size="2"> | <a href="<?php echo htmlentities($_SERVER['PHP_SELF'])."?ty=a&cust_code=$cust_code" ?>">New</a>  |
						<a href="<?php echo htmlentities($_SERVER['PHP_SELF'])."?ty=v&cust_code=$cust_code&custship_id=$custship_id" ?>">View</a>  |
                        <a href="<?php echo "customers.php?ty=e&cust_code=$cust_code" ?>">Customer</a>  | </font></td>
                      <td colspan="4" align="right"><font size="2">|
                        <a href="<?php echo "ar_proc.php?cmd=custship_del&custship_id=$custship_id&cust_code=$cust_code" ?>">Delete</a>  | </font></td>
                    </tr>
                    <tr align="right"> 
          ...
          <tr bgcolor="white"> 
            <td width="476" valign="top"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr> 
                  ...
                  <td> 
                    <?= $f->fillSelectBox($weekbox,"custship_delv_week", "value", "name", $custship_delv_week) ?>
                  </td>
                </tr>
                <tr> 
