...
<HTML>
<HEAD>
<title><?= $label[$lang]["Popup_Vendor_Codes"] ?></title>
                  ...
                  <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr align="right"> 
                      <td colspan="8"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                          <tr> 
                            <th bgcolor="gray"><font color="white">Sales Rep#</font></th>
...
?>
							...
							<a href="javascript:setCode('<?= rawurlencode($recs[$i]["slsrep_code"]) ?>');"><?= $recs[$i]["slsrep_code"] ?></a>
                            </td>
                            <td width="80%"> 
                              <?= $recs[$i]["slsrep_name"] ?>
                            </td>
