<?php
	...
	if ($ht=="e") $sty = unserialize(base64_decode($_SESSION[styles_edit]));
	else $sty = unserialize(base64_decode($_SESSION[styles_add]));
...
<!--
	...
	function EditDtl() {
		...
		f.cmd.value = "style_detail_sess_edit";
		f.method = "post";
		f.submit();
	}
//-->
						...
						<form method=get action="ic_proc.php">
						<INPUT TYPE="hidden" name="cmd" value="">
						<INPUT TYPE="hidden" name="styldtl_styl_code" value="<?= $styl_code ?>">
						<?= $f->fillHidden("ht", $ht) ?>						
						<?= $f->fillHidden("did", $did) ?>
                    <tr align="right"> 
                      <td colspan="8"><strong><?= $label[$lang][Edit_Style_Detail] ?></strong></td>
                    </tr>
                    <tr align="right"> 
                      <td colspan="8" align="left"><font size="2">
							   | <a href="<?php echo htmlentities($_SERVER['PHP_SELF'])."?ty=a&styl_code=$styl_code" ?>"><?= $label[$lang]["New_1"] ?></a> |
                        <a href="<?= "styles.php?ty=$ht&styl_code=$styl_code" ?>"><?= $label[$lang]["Header_1"] ?></a> |</font></td>
                    </tr>
                    <tr align="right"> 
          ...
          <tr bgcolor="white"> 
            <td width="477" align="right"><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="white">
                <tr> 
                  <td width="170" align="right" bgcolor="silver"><?= $label[$lang][Component_Code] ?>:&nbsp;</td>
