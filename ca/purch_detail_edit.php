<?php
	...
	if ($ht == "e") $purdtl = unserialize(base64_decode($_SESSION["purdtls_edit"]));
	else $purdtl = unserialize(base64_decode($_SESSION["purdtls_add"]));
	if ($purdtl[$did]) foreach ($purdtl[$did] as $k => $v) $$k = $v;
...
//-->
                    ...
                    <tr align="right"> 
                      <td colspan="8"><strong><?= $label[$lang][Edit_Purchase_Detail] ?></strong></td>
                    </tr>
                    <tr align="right"> 
          ...
          <tr bgcolor="white"> 
            <td width="477" align="right"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <tr> 
                  ...
                  <td width="308"> 
                    <?= $f->fillSelectBox($selbox, "purdtl_item_code", "value", "name", $purdtl_item_code); ?>
                  </td>
                </tr>
                <tr> 
                ...
                <tr> 
                  ...
                  <td> 
                    <?= $f->fillTextBox("purdtl_qty", $purdtl_qty, 20, 32, "inbox") ?>
                  </td>
                </tr>
                <tr> 
                  <td width="150" align="right" bgcolor="silver"><?= $label[$lang]["Cost"] ?>:&nbsp;</td>
                  <td> 
                    <?= $f->fillTextBox("purdtl_cost", $purdtl_cost, 20, 32, "inbox") ?>
                  </td>
                </tr>
                <tr> 
                  <td width="150" align="right" bgcolor="silver"><?= $label[$lang]["Unit"] ?>:&nbsp;</td>
                  <td> 
