...
//	window.alert(value+desc+price);
	...
	s.purdtl_item_code.value = value;
	
	s.purdtl_item_desc.value = desc;
	
//	s.purdtl_cost.value = price;
	
	s.purdtl_unit.value = unit;
	s.purdtl_qty.value = 1;
//	s.amount.value = Math.round(parseFloat(s.purdtl_qty.value)*parseFloat(price)*100)/100;
//	if (tax == 't') s.purdtl_taxable.checked;
...
?>
                            ...
                            <td width="15%" align="right"> 
                              <?= number_format($recs[$i]["item_last_cost"] ?? 0,2,".",",") ?>
                            </td>
                            <td width="15%" align="right"> 
                              <?= number_format($recs[$i]["item_avg_cost"] ?? 0,2,".",",") ?>
                            </td>
                            <td width="1%"> 
...
?>
                    ...
                    <tr align="center"> 
                      <td colspan="1">
					    <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?objname=$objname&pg=1&ft=$ft" ?>">&lt;&lt;<?= $label[$lang]["First"] ?></a>
                        ...
                        &nbsp; <a href="<?= htmlentities($_SERVER['PHP_SELF'])."?objname=$objname&pg=$totalpage&ft=$ft" ?>"><?= $label[$lang]["Last"] ?>&gt;&gt;</a>
					  </td>
                    </tr>
                  </table>
