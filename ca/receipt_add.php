<?php
	...
	if (isset($_SESSION["receipt_add"])) if ($disb = $_SESSION["receipt_add"]) foreach($disb as $k => $v) $$k = $v;
...
//-->
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
						<form method=post action="ar_proc.php">
							<?= $f->fillHidden("cmd","") ?>
                    <tr> 
                      <td colspan="8" align="right"><strong>New Cash Receipt</strong></td>
                    </tr>
                    <tr> 
...
--><?= $f->fillHidden("rcpt_id", $rcpt_id) ?>
                          <tr> 
                            <td width="97" align="right" bgcolor="silver">Check no:</td>
                            <td width="308"> 
                          ...
                          <tr> 
                            <td width="97" align="right" bgcolor="silver">User #&nbsp;</td>
                            <td> 
