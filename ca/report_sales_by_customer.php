  ...
  <tr>
    <td align="left"><font size="2">&nbsp; </font> 
      <table width="100%" border="0" cellspacing="1" cellpadding="1">
	    <FORM METHOD=POST ACTION="report_sales_by_customer_out.php">
        ...
        <tr>
          <td width="10%">&nbsp;</td>
          <td width="29%" bgcolor="silver">Show Amount</td>
          <td width="1%">&nbsp;</td>
          <td width="50%"><INPUT TYPE="checkbox" NAME="show_amount" value="t"></td>
          <td width="10%">&nbsp;</td>
        </tr>
        <tr>
          <td colspan="4">&nbsp;</td>
        ...
        <tr>
          ...
          <td width="50%">
            <SELECT NAME="sby">
              ...
              <option value="v">Avg.Price</option>
            </SELECT>
          </td>
          <td width="10%">&nbsp;</td>
        </tr>
