<?php
	...
	if (!empty($slsdtl_item_code) && $ctrl == 1) {
		...
		if ($tarr = $t->getItems($slsdtl_item_code)) {
			...
			if (empty($slsdtl_qty) || $slsdtl_qty==0) $slsdtl_qty = 1;
...
//-->
						...
						<form method=get action="ibm_build_proc.php">
							...
							<?= $f->fillHidden("ctrl", "") ?>
                    <tr align="right"> 
                      <td colspan="1"><strong><?= $label[$lang][New_Sale_Detail] ?></strong></td>
                    </tr>
                    <tr align="right"> 
...
?>
                <tr> 
                  ...
                  <td width="450"> 
                    <?= $f->fillTextBox("slsdtl_item_desc", stripslashes($slsdtl_item_desc), 40, 250, "inbox") ?>
...
?>
                            <td width="5%" align="center"> 
                              <a href="itm_build_details.php?ty=e&ht=<?= $ht ?>&did=<?= $i ?>"><?= $i+1 ?></a>
                            </td>
                            <td width="15%"> 
